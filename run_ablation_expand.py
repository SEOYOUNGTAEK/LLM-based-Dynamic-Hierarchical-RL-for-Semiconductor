...
CONDITIONS = [
    ("Ablation_SoftReward_s{seed}", "train_ablation_soft.py",      []),
    ("Ablation_RandomMask_s{seed}", "train_ablation_randmask.py",  []),
    ("RuleBased_LLM_s{seed}_abl",   "train_baseline_rulebased.py", []),
]
